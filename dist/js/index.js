...
var Track = class {
  ...
  track = (0, import_jquery.default)(".track");
  track_length = 0;
  init() {
    this.track_length = Misc_default.get_width(this.track);
...
var Train = class {
  ...
  train = (0, import_jquery2.default)(".train");
  drive_switch = (0, import_jquery2.default)("#drive_state");
  speed_slider = (0, import_jquery2.default)("#sim-train-speed");
  stat_distance_driven = (0, import_jquery2.default)("#sim-stat-distancedriven");
  stat_train_speed = (0, import_jquery2.default)("#sim-train-speed-display-value");
  track = track.track;
  drive_state = 0;
  position = 0;
  speed = 0;
  ...
  init() {
    ...
    (0, import_jquery2.default)(document).on("keyup", (e) => {
    ...
    (0, import_jquery2.default)(document).on("keydown", (e) => {
      if ((e.key === "d" || e.key === "ArrowRight" || e.key === "w" || e.key === "ArrowUp") && this.speed < 160) {
        this.keyDown = true;
        this.keyDownIncrement = 1;
        this.currentKeyDown = e.key;
        this.set_speed((0, import_lodash.clamp)(this.get_speed() + this.keyDownIncrement, 0, this.maxSpeed));
  ...
  update = () => {
    ...
    if (deltaTime >= this.frameTime) {
      this.speedPixelPerSec = this.speed * (1e3 / 3600);
      if (this.drive_state === 1 && this.speed > 0 && this.position < 1500) {
        this.position += this.speedPixelPerSec * (deltaTime / 1e3);
        this.position = Math.min(this.position, 1500);
        if (this.startTime === null) {
          this.startTime = currentTime;
        }
        this.timeTaken = (currentTime - this.startTime) / 1e3;
  ...
  set_position(pos) {
    this.position = (0, import_lodash.clamp)(pos, 0, 1500);
...
// index.ts
var track = new Track().init();
var train = new Train().init();
M.Range.init((0, import_jquery3.default)(".range-field>input"));
M.Tooltip.init((0, import_jquery3.default)(".tooltipped"));
var indicators = /* @__PURE__ */ new Map();
(0, import_jquery3.default)(".indicator").each((i, ind) => {
  let el = (0, import_jquery3.default)(ind), id = parseInt(el.attr("idx"));
  indicators.set(id, {
    element: el,
    name: el.attr("name"),
    id,
    active: false,
    toggle: (state, blink) => {
      state = state !== void 0 ? state : !(el.hasClass("active") || el.hasClass("active-blink"));
      state ? blink ? el.addClass("active-blink") : el.addClass("active") : el.removeClass("active active-blink");
    }
  });
  (0, import_jquery3.default)(`input[idx=${id}]`).on("click", (e) => {
    let el2 = (0, import_jquery3.default)(e.currentTarget), id2 = parseInt(el2.attr("idx")), indicator = indicators.get(id2), state = el2.val() == "on" ? true : false;
    indicator.active = state;
    indicator.toggle(state);
    el2.val() == "on" ? el2.val("off") : el2.val("on");
