...
(0, import_jquery.default)(".indicator").each((i, ind) => {
  let el = (0, import_jquery.default)(ind), id = parseInt(el.attr("idx"));
  indicators.set(id, {
    element: el,
    name: el.attr("name"),
    id,
  ...
  (0, import_jquery.default)(`input[idx=${id}]`).on("click", (e) => {
    let el2 = (0, import_jquery.default)(e.currentTarget), id2 = parseInt(el2.attr("idx")), indicator = indicators.get(id2), state = el2.val() == "on" ? true : false;
